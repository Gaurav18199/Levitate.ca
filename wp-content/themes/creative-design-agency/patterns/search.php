<?php
 /**
  * Title: Search
  * Slug: creative-design-agency/search
  */
?>
<!-- wp:columns -->
...
<p class="has-text-align-center has-heading-color has-text-color has-link-color"><?php esc_html_e( 'Sorry Nothing Found. Try searching..!!', 'creative-design-agency' ); ?></p>
<!-- /wp:paragraph -->
<!-- /wp:query-no-results -->
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"creative-design-agency","tagName":"div"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->